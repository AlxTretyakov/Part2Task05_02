import inno.tretyakov.entity.*;
import inno.tretyakov.repository.*;
...
public class TestModule {
    ...
    void task05Test01(){
        ...
        System.out.println("Тест 1 для задачи номер 5");

        AccountPool ap = new AccountPool(null,null,"001","643","666","01","600");
        Account acc = new Account(null, ap, "40817810455555444456777",false);
        ...
        Assertions.assertEquals(ap.getId(),1);
    ...
    void task05Test02(){
        ...
        Assertions.assertEquals("500", response2.jsonPath().getString("errorCode"));
    }
